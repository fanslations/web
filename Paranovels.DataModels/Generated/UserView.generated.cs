// This class was automatically generated with love by ST4bby 7/28/2015 11:47:57 AM.
...
namespace Paranovels.DataModels
{
	...
	[Table("UserView")]
	public partial class UserView : IDataModel
	{
		[NotMapped]public int ID { get { return UserViewID; } set { UserViewID = value; } }
	
		[Key, Required(AllowEmptyStrings = true), DisplayFormat(ConvertEmptyStringToNull = false), Column("UserViewID", TypeName = "int"), Display(Name="User View ID")]
