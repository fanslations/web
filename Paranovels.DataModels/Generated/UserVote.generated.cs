// This class was automatically generated with love by ST4bby 7/22/2015 12:43:54 PM.
...
namespace Paranovels.DataModels
{
	...
	[Table("UserVote")]
	public partial class UserVote : IDataModel
	{
		[NotMapped]public int ID { get { return UserVoteID; } set { UserVoteID = value; } }
	
		[Key, Required(AllowEmptyStrings = true), DisplayFormat(ConvertEmptyStringToNull = false), Column("UserVoteID", TypeName = "int"), Display(Name="User Vote ID")]
		...
		[Required(AllowEmptyStrings = true), DisplayFormat(ConvertEmptyStringToNull = false), Column("Vote", TypeName = "int"), Display(Name="Vote")]
