...
namespace Paranovels.ViewModels
{
    ...
    {
        public static IDictionary<string, string> SortOptions(this IQueryable<AuthorGrid> grids)
        {
        ...
        public static IQueryable<AuthorGrid> Sort(this IQueryable<AuthorGrid> grids, BaseCriteria criteria)
        {
