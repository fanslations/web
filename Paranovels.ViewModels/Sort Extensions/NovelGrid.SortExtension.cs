...
namespace Paranovels.ViewModels
{
    ...
    {
        public static IDictionary<string, string> SortOptions(this IQueryable<NovelGrid> grids)
        {
        ...
        public static IQueryable<NovelGrid> Sort(this IQueryable<NovelGrid> grids, BaseCriteria criteria)
        {
